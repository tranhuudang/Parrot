...
class MainHomeState with _$MainHomeState {
  const factory MainHomeState({
    ...
    required DownloadedFlutterSDK? selectedVersionToSwitchTo,
    required DownloadedFlutterSDK? currentFlutterVersionSwitchedTo,
    required bool isJustOpened,
  ...
  factory MainHomeState.initial() => const MainHomeState(
        ...
        selectedVersionToSwitchTo: null,
        isJustOpened: true,
        ...
        isSwitching: false,
        currentFlutterVersionSwitchedTo: null,
